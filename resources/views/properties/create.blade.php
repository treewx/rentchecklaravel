                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       ...
                                       placeholder="e.g., 53 Beauzami Cr">
                                @error('name')
                        ...
                        <div class="col-md-5">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('tenant_email') is-invalid @enderror"
                                       id="tenant_email" name="tenant_email" value="{{ old('tenant_email') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" id="notify_on_missed_payment"
                                           ...
                                           {{ old('notify_on_missed_payment') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('grace_period_days') is-invalid @enderror"
                                    ...
                                    <option value="0" {{ old('grace_period_days') == '0' ? 'selected' : '' }}>No delay</option>
                                    <option value="1" {{ old('grace_period_days') == '1' ? 'selected' : '' }}>1 day</option>
                                    <option value="2" {{ old('grace_period_days') == '2' ? 'selected' : '' }}>2 days</option>
                                    <option value="3" {{ old('grace_period_days') == '3' ? 'selected' : '' }}>3 days</option>
                                </select>
