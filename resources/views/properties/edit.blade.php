                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('rent_start_date') is-invalid @enderror"
                                       id="rent_start_date" name="rent_start_date" 
                                       value="{{ old('rent_start_date', $property->rent_start_date ? $property->rent_start_date->format('Y-m-d') : '') }}"
                                       min="{{ date('Y-m-d') }}">
                                <div class="form-text">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (rentDueDayInput) {
        ...
        // Validate on page load if both fields have values
