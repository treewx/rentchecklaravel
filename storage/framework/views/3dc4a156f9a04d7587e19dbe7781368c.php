<?php $__env->startSection('title', 'Settings - Rent Tracker'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('settings.email-preferences')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="email_notifications_enabled"
                                   ...
                                   <?php echo e($user->email_notifications_enabled ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input email-type-checkbox"
                                       ...
                                       <?php echo e($user->email_on_rent_received ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input email-type-checkbox"
                                       ...
                                       <?php echo e($user->email_on_rent_late ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input email-type-checkbox"
                                       ...
                                       <?php echo e($user->email_on_rent_partial ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEdward\Projects3\rent\resources\views/settings/index.blade.php ENDPATH**/ ?>