<?php $__env->startSection('title', 'Connect Akahu - Rent Tracker'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('akahu.store-tokens')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['app_token'];
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               placeholder="app_token_xxxxxxxx..." required><?php echo e(old('app_token')); ?></textarea>
                        <?php $__errorArgs = ['app_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['user_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               placeholder="user_token_xxxxxxxx..." required><?php echo e(old('user_token')); ?></textarea>
                        <?php $__errorArgs = ['user_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DEdward\Projects3\rent\resources\views/akahu/connect.blade.php ENDPATH**/ ?>